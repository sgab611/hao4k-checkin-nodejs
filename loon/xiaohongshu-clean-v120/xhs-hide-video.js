...
/*
 * 小红书隐藏视频脚本
 * 1. 同时包含去广告逻辑，减少脚本叠加带来的不确定性
 * 2. 更宽松识别 note/tabfeed、videofeed、widgets 等响应中的视频卡片
 */
...
const VIDEO_VALUE_RE = /(video|videofeed|video_note|video_post|note_video|media_video|redtube)/i;
...
try {
  ...
  console.log("xhs-hide-video-v120 parse failed: " + error.message);
